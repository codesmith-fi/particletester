    ...
    public abstract class MovableGameObject : GameObjectBase
    {
        ...
        public virtual float X
        {
            ...
            set 
            {
                if (value != position.X)
                {
                    OnPositionChanged(position, new Point(value, position.Y));
                }
                position.X = value; 
            }
        }
        ...
        public virtual float Y
        {
            ...
            set
            {
                if (value != position.Y)
                {
                    OnPositionChanged(position, new Point(position.X, value));
                }
                position.Y = value;
            }
        }
        ...
        private void OnPositionChanged(Point oldPosition, Point newPosition)
        {
